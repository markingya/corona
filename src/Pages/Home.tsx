...
const Home = () => {
  return (
    <div className="bg-[url('/Images/redcheck.jpg')] min-h-screen bg-cover bg-center bg-no-repeat">
      <div className="flex flex-col min-h-screen gap-15 items-center py-15 px-5">
       
          <div className="bg-gray-50 lg:max-w-3xl md:max-w-xl max-w-sm w-full p-5 md:p-8 rounded-2xl border-4 border-cred ring-2 ring-black/8 relative">
            <h1 className="font-corona text-indigo-800 text-xl md:text-2xl lg:text-4xl text-center leading-snug">
              <span className="block relative pb-4 after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-cred">
              The Official Website of
              </span>
              <span className="block relative py-4 after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-cred">
            ...
            <img src="/Images/coronaLogo.png" alt="Corona Logo" className="absolute lg:-top-12 md:-top-10 md:-right-8 -top-6 lg:-right-10 -right-4 -rotate-20 w-15 md:w-30"/>
          </div>
